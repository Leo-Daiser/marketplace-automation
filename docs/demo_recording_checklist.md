...
- Нельзя говорить, что подключен production WB/Ozon API, если реальные кабинеты продавца не подключены.
- Нельзя говорить, что ответы на отзывы по БАДам можно публиковать без ручного согласования.
- Нельзя говорить, что это уже production deployment.
